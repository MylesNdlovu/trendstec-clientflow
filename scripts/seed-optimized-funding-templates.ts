/**
 * Optimized Funding Templates - Low CPC/CPL
 * Removes specific demographics, focuses on clicks and sign-ups
 * Highly attractive but not too specific
 *
 * Run with: npx tsx scripts/seed-optimized-funding-templates.ts
 */
...
async function seedOptimizedTemplates() {
	console.log('🚀 Starting Optimized Funding Templates seeding...\n');
	...
	try {
		...
		console.log(`\n🎉 Seeding complete! Created ${fundingTemplates.length} optimized templates.\n`);

		console.log('📊 Optimization Strategy:');
		console.log('   ✅ Removed: Specific demographics (students, Africans, etc.)');
		console.log('   ✅ Focus: Click-optimized headlines');
		console.log('   ✅ Goal: Lower CPC/CPL');
		console.log('   ✅ Targeting: Broad appeal, urgency, scarcity');
		console.log('   ✅ Countries: 10 lucrative markets (ZA, NG, KE, GH, EG, MA, TZ, UG, ZM, BW)\n');
